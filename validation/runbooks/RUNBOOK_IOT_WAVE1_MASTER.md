...
- Scope lock: operate only inside <REPO_ROOT>.
...
- PRD: <REPO_ROOT>/docs/PRD_IOT_EXTERNAL_BASELINE_AND_DT09_2026-02-20.md
- Output root: <REPO_ROOT>/validation/results/2026-02-20_iot_external_baseline_dt09
...
- PRD: <REPO_ROOT>/docs/PRD_IOT_EXTERNAL_BASELINE_AND_DT09_2026-02-20.md
- Scope lock: <REPO_ROOT> only (no IMC/Bio edits).
- Mandatory evidence inputs read:
  - <WORKSPACE>/ZPE Multimodality/ZPE IoT_ Research Concept & Agent Execution Document.md
  - <WORKSPACE>/ZPE Multimodality/ZPE_IMC_TECHNICAL_DOSSIER.md
  - <REPO_ROOT>/docs/BENCHMARKS.md
  - <REPO_ROOT>/validation/destruct_tests/dt09_latency.py
