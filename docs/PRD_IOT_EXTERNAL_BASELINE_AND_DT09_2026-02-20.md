...
- Date: 2026-02-20
- Repo root: `/Users/prinivenpillay/ZPE IoT/zpe-iot`
- Priority: P0
...
1. `/Users/prinivenpillay/ZPE IoT/zpe-iot/validation/destruct_tests/dt09_latency.py`
2. `/Users/prinivenpillay/ZPE IoT/zpe-iot/docs/BENCHMARKS.md`
3. `/Users/prinivenpillay/ZPE Multimodality/ZPE_IMC_TECHNICAL_DOSSIER.md`
...
Output folder:
- `/Users/prinivenpillay/ZPE IoT/zpe-iot/validation/results/<DATE>_iot_external_baseline_dt09/`
...
2. Convert all material claims in `/Users/prinivenpillay/ZPE Multimodality/ZPE IoT_ Research Concept & Agent Execution Document.md` into executable gates with reproducible artifacts.

Evidence inputs (mandatory read before execution):
1. `/Users/prinivenpillay/ZPE Multimodality/ZPE IoT_ Research Concept & Agent Execution Document.md`
2. `/Users/prinivenpillay/ZPE Multimodality/ZPE_IMC_TECHNICAL_DOSSIER.md`
3. `/Users/prinivenpillay/ZPE IoT/zpe-iot/docs/BENCHMARKS.md`
4. `/Users/prinivenpillay/ZPE IoT/zpe-iot/validation/destruct_tests/dt09_latency.py`
...
Output folder:
- `/Users/prinivenpillay/ZPE IoT/zpe-iot/validation/results/2026-02-21_iot_external_baseline_augmented/`
...
1. Work only inside `/Users/prinivenpillay/ZPE IoT/zpe-iot`.
