...
### Key Evidence
- `<REPO_ROOT>/validation/results/2026-02-20_iot_external_baseline_dt09/dt09_semantics_recheck.json`
- `<REPO_ROOT>/validation/results/2026-02-20_iot_external_baseline_dt09/gateD_strict_replay.json`
- `<REPO_ROOT>/validation/results/2026-02-20_iot_external_baseline_dt09/iot_external_baseline_results.json`
- `<REPO_ROOT>/validation/results/2026-02-20_iot_external_baseline_dt09/claim_status_delta.md`
...
- PRD: `<REPO_ROOT>/docs/PRD_IOT_EXTERNAL_BASELINE_AND_DT09_2026-02-20.md`
- Scope: `<REPO_ROOT>` only.
