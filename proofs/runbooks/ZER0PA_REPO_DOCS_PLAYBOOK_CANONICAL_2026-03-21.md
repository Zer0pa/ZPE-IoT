...
- legacy ops/evidence root: `<WORKSPACE>/ZPE-IMC/agent_ops`
...
Read first:
1. <WORKSPACE>/ZPE-IMC/agent_ops/ZER0PA_REPO_DOCS_PLAYBOOK_CANONICAL_2026-03-21.md
...
- `<WORKSPACE>/ZPE-IMC/agent_ops/ZER0PA_REPO_DOCS_PLAYBOOK.md`
- `<WORKSPACE>/ZPE-IMC/agent_ops/HANDOVER_REPO_DOCS_STATE_AND_REPO_INSPECTOR_PROMPT_2026-03-02.md`
- `<WORKSPACE>/ZPE-IMC/agent_ops/readme_layout_wave_8/GITHUB_DOCS_DESIGN_PLAYBOOK_GOLD_STANDARD.md`
