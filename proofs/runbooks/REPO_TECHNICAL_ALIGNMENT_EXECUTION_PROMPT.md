...
1. `<WORKSPACE>/Git Orchestreator/AGENT_RULES.md`
2. `<WORKSPACE>/Git Orchestreator/WORK_RECEIPT_TEMPLATE.md`
...
`<WORKSPACE>/Git Orchestreator/WORK_RECEIPT_TEMPLATE.md`
